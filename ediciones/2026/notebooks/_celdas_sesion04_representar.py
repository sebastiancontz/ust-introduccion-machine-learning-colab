#!/usr/bin/env python3
"""Celdas de la SEGUNDA MITAD de la sesión 4: representar lo que ya está bien.

Ya no construye un notebook por su cuenta. Expone `CELDAS`, `contrato()` y sus ayudantes para que
`_build_04_preparacion.py` las empalme con las de la primera mitad en el cuaderno único de la
